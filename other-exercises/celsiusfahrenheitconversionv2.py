...
while True:
    try:
        ...
        if user_temperature_scale in ['F', 'f']:
            ...
            print("Invalid temperature scale value detected. Did you mean to write C or F for temperature scale?")
    except ValueError as e:
        print("")
        print(f"Invalid input detected; {e}")
    except KeyboardInterrupt:
        print("")
        print("KeyboardInterrupt detected. Exiting temperature conversion program...")
        sys.exit(0)
